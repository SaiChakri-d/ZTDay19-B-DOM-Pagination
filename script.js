...
var arr=[
  ...
  div.classList.add("container-xl")
  document.body.appendChild(div)

  var divele=document.createElement("div")
  div.appendChild(divele)
  divele.classList.add("table-responsive")
  let head1=document.createElement("h1")
  head1.classList.add("fs-1","text-center")
  head1.setAttribute("id","title")
  head1.innerText="Pagination"
 divele.appendChild(head1)

  
    divele.appendChild(document.getElementById("pg"))
      divele.appendChild(document.getElementById("pgno"))
  
      btntable=document.createElement("p")
      btntable.classList.add("fs-3","lh=2")
      divele.appendChild(btntable)

      table=document.createElement("table")
      table.align='center';
      table.setAttribute("id","description")
      btntable.appendChild(table)
      
  
      let h3=document.createElement("h3")
      h3.classList.add("fs-3","text-center")
      h3.innerText="Use the buttons below to navigate between the pages"
      divele.appendChild(h3)

      btnpara=document.createElement("p")
btnpara.classList.add("text-center")
divele.appendChild(btnpara)
  
var first=document.createElement("button")
  first.innerText="First"
  first.setAttribute("id","fs")
  first.setAttribute("Onclick","firstpage()")
  btnpara.appendChild(first)

  var previous=document.createElement("button")
   previous.innerText="Previous"
   previous.setAttribute("id","fs")
   previous.setAttribute("Onclick","previouspage()")
   btnpara.appendChild(previous)

  var one=document.createElement("button")
  one.innerText="1"
  one.setAttribute("id","fs")
  one.setAttribute("Onclick","firstpage()")
  btnpara.appendChild(one)


  var two=document.createElement("button")
    two.innerText="2"
   two.setAttribute("id","fs")
   two.setAttribute("Onclick","secondpage()")
   btnpara.appendChild(two)

   var three=document.createElement("button")
      three.innerText="3"
    three.setAttribute("id","fs")
    three.setAttribute("Onclick","thirdpage()")
    btnpara.appendChild(three)


    var four=document.createElement("button")
        four.innerText="4"
     four.setAttribute("id","fs")
     four.setAttribute("Onclick","fourthpage()")
     btnpara.appendChild(four)

 
     var five=document.createElement("button")
         five.innerText="5"
      five.setAttribute("id","fs")
      five.setAttribute("Onclick","fifthpage()")
      btnpara.appendChild(five)

  
      var six=document.createElement("button")
       six.innerText="6"
      six.setAttribute("id","fs")
      six.setAttribute("Onclick","sixthpage()")
      btnpara.appendChild(six)


      var seven=document.createElement("button")
       seven.innerText="7"
      seven.setAttribute("id","fs")
      seven.setAttribute("Onclick","seventhpage()")
      btnpara.appendChild(seven)
  
      var eight=document.createElement("button")
        eight.innerText="8"
       eight.setAttribute("id","fs")
       eight.setAttribute("Onclick","eigthpage()")
       btnpara.appendChild(eight)

   
       var nine=document.createElement("button")
         nine.innerText="9"
      nine.setAttribute("id","fs")
      nine.setAttribute("Onclick","ninthpage()")
      btnpara.appendChild(nine)

  
      var ten=document.createElement("button")
          ten.innerText="10"
      ten.setAttribute("id","fs")
      ten.setAttribute("Onclick","tenthpage()")
      btnpara.appendChild(ten)

      var next=document.createElement("button")
         next.innerText="Next"
        next.setAttribute("id","fs")
        next.setAttribute("Onclick","nextpage()")
        btnpara.appendChild(next)
     

      var last=document.createElement("button")
      last.innerText="Last"
       last.setAttribute("id","fs")
       last.setAttribute("Onclick","tenthpage()")
       btnpara.appendChild(last)
     ...
     function loadpage()
     {
      ...
      row1.classList.add("bg-warning")
      r1d1=document.createElement("td")
      r1d1.innerText="ID"
      r1d1.align="center"
      row1.appendChild(r1d1)

      r1d2=document.createElement("td")
      r1d2.innerText="Name"
      r1d2.align="center"
      row1.appendChild(r1d2)

      r1d3=document.createElement("td")
      r1d3.innerText="Email"
      r1d3.align="center"
      ...
      for(i=0;i<arr1.length;i++)
      {
        ...
        row2.classList.add("bg-light")
        r2d1=document.createElement("td")
        r2d1.classList.add("text-wrap")
        r2d1.align="center"
        r2d1.innerHTML=arr1[i].id
        row2.appendChild(r2d1)
               
        r2d2=document.createElement("td")
        r2d2.innerText=arr1[i].name;
        r2d2.classList.add("text-wrap")
        r2d2.align="center"
        row2.appendChild(r2d2)
  
        r2d3=document.createElement("td")
         r2d3.innerText=arr1[i].email;
         r2d3.classList.add("text-break")
         r2d3.align="center"
        row2.appendChild(r2d3)
